...
public class AngleKeys : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            GetComponent<Transform>().position+=new Vector3(0,Time.deltaTime*0.1f,0);
        }else if(Input.GetKey("e"))
        {
            GetComponent<Transform>().position-=new Vector3(0,Time.deltaTime*0.1f,0);
        }else if(Input.GetKey("w"))
        {
            GetComponent<Transform>().position+=new Vector3(0,0,Time.deltaTime*0.1f);
        }else if(Input.GetKey("s"))
        {
            GetComponent<Transform>().position-=new Vector3(0,0,Time.deltaTime*0.1f);
        }else if(Input.GetKey("a"))
        {
            GetComponent<Transform>().position+=new Vector3(Time.deltaTime*0.1f,0,0);
